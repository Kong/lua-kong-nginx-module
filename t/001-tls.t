...
=== TEST 4: session reuse by session tickets without disable_session_reuse
--- http_config
    lua_package_path "../lua-resty-core/lib/?.lua;lualib/?.lua;;";
...
=== TEST 5: session reuse by session cache without disable_session_reuse
--- http_config
    lua_package_path "../lua-resty-core/lib/?.lua;lualib/?.lua;;";
...
=== TEST 6: disable_session_reuse can suppress usage of session tickets
--- http_config
    lua_package_path "../lua-resty-core/lib/?.lua;lualib/?.lua;;";
...
=== TEST 7: disable_session_reuse can suppress usage of session cache
--- http_config
    lua_package_path "../lua-resty-core/lib/?.lua;lualib/?.lua;;";
...
=== TEST 8: calling get_full_client_certificate_chain in plain text request,
error is returned
--- http_config
    lua_package_path "../lua-resty-core/lib/?.lua;lualib/?.lua;;";
--- config
...
=== TEST 9: calling set_client_ca_list, ca dn list is sent (using `resty.openssl.x509.chain`)
--- http_config
    lua_package_path "../lua-resty-core/lib/?.lua;lualib/?.lua;;";
...
=== TEST 10: calling set_client_ca_list, ca dn list is sent (using `ngx.ssl.parse_pem_cert`)
--- http_config
    lua_package_path "../lua-resty-core/lib/?.lua;lualib/?.lua;;";
...
=== TEST 11: without calling set_client_ca_list, ca dn list isn't sent
--- http_config
    lua_package_path "../lua-resty-core/lib/?.lua;lualib/?.lua;;";
...
=== TEST 12: calling set_client_ca_list with an empty chain, no real effect, ca dn list isn't sent
--- http_config
    lua_package_path "../lua-resty-core/lib/?.lua;lualib/?.lua;;";
