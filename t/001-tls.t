...
=== TEST 1: disable_session_reuse() can suppress usage of session tickets
--- http_config
...
=== TEST 2: disable_session_reuse can suppress usage of session cache
--- http_config
    lua_package_path "../lua-resty-core/lib/?.lua;lualib/?.lua;;";
...
=== TEST 3: get_full_client_certificate_chain behaves normally after requesting the client certificate
--- http_config
    lua_package_path "../lua-resty-core/lib/?.lua;lualib/?.lua;;";
...
=== TEST 4: calling get_full_client_certificate_chain in plain text request,
error is returned
--- http_config
    lua_package_path "../lua-resty-core/lib/?.lua;lualib/?.lua;;";
--- config
