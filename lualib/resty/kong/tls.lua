...
local kong_lua_kong_ffi_request_client_certificate
...
if ngx.config.subsystem == "http" then
    ...
    kong_lua_kong_ffi_request_client_certificate = C.ngx_http_lua_kong_ffi_request_client_certificate
...
elseif ngx.config.subsystem == 'stream' then
    ...
    const char *ngx_stream_lua_kong_ffi_request_client_certificate(ngx_stream_lua_request_t *r);
    int ngx_stream_lua_kong_ffi_get_full_client_certificate_chain(ngx_stream_lua_request_t *r,
        char *buf, size_t *buf_len);
    int ngx_http_lua_kong_ffi_get_full_client_certificate_chain(
        ngx_stream_lua_request_t *r, char *buf, size_t *buf_len);
    ...
    kong_lua_kong_ffi_request_client_certificate = C.ngx_stream_lua_kong_ffi_request_client_certificate
