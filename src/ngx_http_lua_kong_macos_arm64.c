...
int
ngx_http_lua_kong_ffi_shdict_get(ngx_http_lua_kong_shdict_get_t *s)
{
...
int
ngx_http_lua_kong_ffi_shdict_store(ngx_http_lua_kong_shdict_store_t *s)
{
...
int
ngx_http_lua_kong_ffi_shdict_incr(ngx_http_lua_kong_shdict_incr_t *s)
{
...
int
ngx_http_lua_kong_ffi_set_resp_header(ngx_http_lua_kong_set_resp_header_t *s)
{
